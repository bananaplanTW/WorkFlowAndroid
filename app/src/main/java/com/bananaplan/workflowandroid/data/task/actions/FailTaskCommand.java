 ...
 */
public class FailTaskCommand implements ITaskActionCommand, PostRequestAsyncTask.OnFinishPostingDataListener  {

    private PostRequestAsyncTask mPostRequestAsyncTask;
    private Context mContext;
    private String mTaskId;

    public FailTaskCommand (Context context, String taskId) {
        mContext = context;
        mTaskId = taskId;
    }
    ...
    public void execute() {
        ...
        PostRequestStrategy postRequestStrategy = new PostRequestStrategy(LoadingDataUtils.WorkingDataUrl.EndPoints.FAIL_TASK, headers, bodies);
