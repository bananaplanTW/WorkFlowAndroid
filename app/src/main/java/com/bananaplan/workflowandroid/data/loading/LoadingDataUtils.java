...
public class LoadingDataUtils {
    ...
    public static void loadWarnings(Context context) {
        try {
            ...
            String urlString = URLUtils.buildURLString(sBaseUrl, WorkingDataUrl.EndPoints.WARNINGS, null);
    ...
    public static void loadEmployees(Context context) {
        try {
            String urlString = URLUtils.buildURLString(sBaseUrl, WorkingDataUrl.EndPoints.EMPLOYEES, null);
            HashMap<String, String> headers = new HashMap<>();
            headers.put("x-user-id", WorkingData.getUserId());
            headers.put("x-auth-token", WorkingData.getAuthToken());
...
//            Log.d(TAG, "Case lastUpdatedTime = " + lastUpdatedTime);
    ...
    private static String getEquipmentTimeCardUrl(String equipmentId, long startDate, long endDate) {
        ...
        String url = URLUtils.buildURLString(sBaseUrl, WorkingDataUrl.EndPoints.TIME_CARD_BY_RESOURCE, queries);
